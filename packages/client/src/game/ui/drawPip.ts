...
shapeFunctions.set(
  "hanabiRed",
  (ctx: CanvasRenderingContext2D, highLight?: boolean) => {
    ctx.beginPath();
    ...
    ctx.closePath();
    if (highLight === true) {
      ctx.lineWidth = highLightWidth / scaleFactor;
      ctx.stroke();
      ctx.lineWidth = (highLightWidth - 3) / scaleFactor;
...
shapeFunctions.set(
  ...
  (ctx: CanvasRenderingContext2D, highLight?: boolean) => {
    ...
    if (highLight === true) {
      ...
      ctx.stroke();
      ctx.lineWidth = highLightWidth - 3;
      ctx.fillStyle = "orange";
      ctx.strokeStyle = "orange";
      ctx.stroke();
      ctx.fill();
...
shapeFunctions.set(
  ...
  (ctx: CanvasRenderingContext2D, highLight?: boolean) => {
    ...
    if (highLight === true) {
      ctx.lineWidth = (highLightWidth * 3) / scaleFactor;
      ctx.stroke();
      ctx.lineWidth = ((highLightWidth - 3) * 3) / scaleFactor;
      ctx.fillStyle = "orange";
      ctx.strokeStyle = "orange";
      ctx.stroke();
      ctx.fill();
...
export default function drawPip(
  ...
  if (secondary === true) {
    ...
    if (highLight === true) {
      ctx.lineWidth = highLightWidth / 0.8;
      ctx.stroke();
      ctx.lineWidth = highLightWidth / 0.8;
      ctx.fillStyle = "orange";
      ctx.strokeStyle = "orange";
  ...
  if (hasCustomFill) {
    ...
    shapeFunction(
      ctx,
      highLight === true && secondary !== true,
      suit.fillColors,
    );
  } else {
    // All other suits have a solid fill
    shapeFunction(ctx, highLight === true && secondary !== true);
    ctx.fillStyle = suit.fill;
    ctx.fill();
  }
