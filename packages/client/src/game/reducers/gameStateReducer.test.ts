...
describe("gameStateReducer", () => {
  test("does not mutate state", () => {
    ...
    const newState = gameStateReducer(state, draw(0, 0), true, false, defaultMetadata);
  ...
  describe("turn", () => {
    test("is properly incremented (integration test)", () => {
      ...
      state = gameStateReducer(state, testClue, true, false, defaultMetadata);
  ...
  describe("efficiency", () => {
    test("is Infinity after a play on the first turn", () => {
      ...
      state = gameStateReducer(state, drawAction, true, false, defaultMetadata);

      // Blind-play that red 1.
      const playAction = play(0, 0, 0, 1);
      state = gameStateReducer(state, playAction, true, false, defaultMetadata);
    ...
    test("is 0 after a misplay on the first turn", () => {
      ...
      state = gameStateReducer(state, discardAction, true, false, defaultMetadata);

      // TODO: remove this when misplays are calculated from an ActionPlay
      // Mark a strike
      const strikeAction = strike(1, 0, 1);
      state = gameStateReducer(state, strikeAction, true, false, defaultMetadata);
    ...
    test("is 3 after a 3-for-1 clue", () => {
      ...
      state = gameStateReducer(state, clueAction, true, false, defaultMetadata);
    ...
    test("is decreased after a misplay", () => {
      ...
      state = gameStateReducer(state, drawYellow2Action, true, false, defaultMetadata);

      // Draw a red 1 to player 1.
      const drawRed1Action = draw(1, 1, 0, 1);
      state = gameStateReducer(state, drawRed1Action, true, false, defaultMetadata);
    ...
    test("is decreased after a clue from playing a 5 is wasted", () => {
      ...
      state = gameStateReducer(state, drawRed2Action, true, false, defaultMetadata);
      const drawRed4Action = draw(0, 1, 0, 4);
      state = gameStateReducer(state, drawRed4Action, true, false, defaultMetadata);
      const drawRed5Action = draw(0, 2, 0, 5);
      state = gameStateReducer(state, drawRed5Action, true, false, defaultMetadata);

      // Draw a red 1, a red 3, and a red 1 to player 1.
      const drawRed1Action = draw(1, 3, 0, 1);
      state = gameStateReducer(state, drawRed1Action, true, false, defaultMetadata);
      const drawRed3Action = draw(1, 4, 0, 3);
      state = gameStateReducer(state, drawRed3Action, true, false, defaultMetadata);
      const drawRed1Action2 = draw(1, 5, 0, 1);
      state = gameStateReducer(state, drawRed1Action2, true, false, defaultMetadata);
      ...
      state = gameStateReducer(state, playRed1Action, true, false, defaultMetadata);

      // Player 0 plays the red 2.
      const playRed2Action = play(0, 0, 0, 2);
      state = gameStateReducer(state, playRed2Action, true, false, defaultMetadata);

      // Player 1 plays the red 3.
      const playRed3Action = play(1, 4, 0, 3);
      state = gameStateReducer(state, playRed3Action, true, false, defaultMetadata);

      // Player 0 plays the red 4.
      const playRed4Action = play(0, 1, 0, 4);
      state = gameStateReducer(state, playRed4Action, true, false, defaultMetadata);
      ...
      state = gameStateReducer(state, playRed5Action, true, false, defaultMetadata);
    ...
    describe("Clue Starved", () => {
      test("is decreased after a clue from playing a 5 is wasted", () => {
        ...
        state = gameStateReducer(state, clueAction, true, false, clueStarvedMetadata);
