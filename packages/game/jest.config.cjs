...
const jsoncParser = require("jsonc-parser"); // eslint-disable-line import-x/no-extraneous-dependencies
const { pathsToModuleNameMapper } = require("ts-jest"); // eslint-disable-line import-x/no-extraneous-dependencies
