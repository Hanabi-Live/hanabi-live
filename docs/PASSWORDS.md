...
If you use the same password for every website, it is analogous to not brushing your teeth. You might not get a cavity right away, but eventually not brushing your teeth is going to cause a cavity. Not to mention that it comes off as pretty disgusting for everyone else in the civilized world.
