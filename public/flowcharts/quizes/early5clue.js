var input = [{
    "slug": "Start",
    "text": "It is the <i>Early Game</i> and one or more 5's are clued with number 5.<br /><br />Was the right-most 5 on chop?",
    ...
    "slug": "onlyfiness",
    "text": "Was the only thing left to do to give a <i>Play Clue</i> to a card on <i>Finesse Position</i>?",
    ...
    "slug": "early5cm",
    "text": "It is an <i>Early 5's Chop Move</i>. (They should <i>Chop Move</i> the card to the right of the 5.)",
    "connectsto": "End",
    "connectstext": "The End",
    "rowNumber": 6
}, {
