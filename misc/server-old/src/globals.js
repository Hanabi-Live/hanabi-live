...
module.exports = {
  ...
  mixedSuits: ["Green", "Purple", "Navy", "Orange", "Tan", "Burgundy"],
  mixedClues: ["Blue", "Yellow", "Red", "Black"],
  mmSuits: ["Teal", "Lime", "Orange", "Cardinal", "Indigo", "Rainbow"],
  crazySuits: ["Green", "Purple", "Orange", "White", "Rainbow", "Black"],
  variants: [
    "No Variant",
    "Black Suit",
    "Black Suit 1OE",
