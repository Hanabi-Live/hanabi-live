...
func (s *Session) Status() int {
	if s == nil {
		hLog.Error("The \"Status\" method was called for a nil session.")
		return 0
	}
...
func (s *Session) SetStatus(status int) {
	if s == nil {
		hLog.Error("The \"SetStatus\" method was called for a nil session.")
		return
	}
...
func (s *Session) TableID() uint64 {
	if s == nil {
		hLog.Error("The \"TableID\" method was called for a nil session.")
		return 0
	}
...
func (s *Session) SetTableID(tableID uint64) {
	if s == nil {
		hLog.Error("The \"SetTableID\" method was called for a nil session.")
		return
	}
...
func (s *Session) Friends() map[int]struct{} {
	if s == nil {
		hLog.Error("The \"Friends\" method was called for a nil session.")
...
func (s *Session) ReverseFriends() map[int]struct{} {
	if s == nil {
		hLog.Error("The \"ReverseFriends\" method was called for a nil session.")
		return make(map[int]struct{})
	}
...
func (s *Session) Hyphenated() bool {
	if s == nil {
		hLog.Error("The \"Hyphenated\" method was called for a nil session.")
		return false
	}
...
func (s *Session) SetHyphenated(hyphenated bool) {
	if s == nil {
		hLog.Error("The \"SetHyphenated\" method was called for a nil session.")
		return
	}
...
func (s *Session) Inactive() bool {
	if s == nil {
		hLog.Error("The \"Inactive\" method was called for a nil session.")
		return false
	}
...
func (s *Session) SetInactive(inactive bool) {
	if s == nil {
		hLog.Error("The \"SetInactive\" method was called for a nil session.")
		return
	}
...
func (s *Session) RateLimitAllowance() float64 {
	if s == nil {
		hLog.Error("The \"RateLimitAllowance\" method was called for a nil session.")
...
func (s *Session) SetRateLimitAllowance(rateLimitAllowance float64) {
	if s == nil {
		hLog.Error("The \"SetRateLimitAllowance\" method was called for a nil session.")
		return
	}
...
func (s *Session) RateLimitLastCheck() time.Time {
	if s == nil {
		hLog.Error("The \"RateLimitLastCheck\" method was called for a nil session.")
		return time.Now()
	}
...
func (s *Session) SetRateLimitLastCheck(rateLimitLastCheck time.Time) {
	if s == nil {
		hLog.Error("The \"SetRateLimitLastCheck\" method was called for a nil session.")
		return
	}
...
func (s *Session) Banned() bool {
	if s == nil {
		hLog.Error("The \"Banned\" method was called for a nil session.")
		return false
	}
