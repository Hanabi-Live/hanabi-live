...
// Returns true if A is a worse game result than B
//
// Result A is worse than result B whenever result A has either:
// - a lower score;
// - or an equal score but with more modifiers (by comparing the bitflags numerically)
//
// For example:
