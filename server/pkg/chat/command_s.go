...
func (m *Manager) commandS(d *chatData, args []string, t dispatcher.TableManager) {
...
func (m *Manager) commandS2(d *chatData, args []string, t dispatcher.TableManager) {
	m.commandAutomaticStart(d, t, 2)
}

// /s3 - Automatically start the game as soon as there are 3 players.
func (m *Manager) commandS3(d *chatData, args []string, t dispatcher.TableManager) {
	m.commandAutomaticStart(d, t, 3)
}

// /s4 - Automatically start the game as soon as there are 4 players.
func (m *Manager) commandS4(d *chatData, args []string, t dispatcher.TableManager) {
	m.commandAutomaticStart(d, t, 4)
}

// /s5 - Automatically start the game as soon as there are 5 players.
func (m *Manager) commandS5(d *chatData, args []string, t dispatcher.TableManager) {
	m.commandAutomaticStart(d, t, 5)
}

// /s6 - Automatically start the game as soon as there are 6 players.
func (m *Manager) commandS6(d *chatData, args []string, t dispatcher.TableManager) {
	m.commandAutomaticStart(d, t, 6)
}

func (m *Manager) commandAutomaticStart(d *chatData, t dispatcher.TableManager, numPlayers int) {
